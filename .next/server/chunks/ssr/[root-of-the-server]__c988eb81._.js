...
"[project]/assets/tradingpic.png.mjs { IMAGE => \"[project]/assets/tradingpic.png (static in ecmascript)\" } [app-ssr] (structured image object, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/assets/multiscale.png.mjs { IMAGE => \"[project]/assets/multiscale.png (static in ecmascript)\" } [app-ssr] (structured image object, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/pages/hero.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$assets$2f$tradingpic$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$assets$2f$tradingpic$2e$png__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object$2c$__ecmascript$29$__ = __turbopack_context__.i('[project]/assets/tradingpic.png.mjs { IMAGE => "[project]/assets/tradingpic.png (static in ecmascript)" } [app-ssr] (structured image object, ecmascript)');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$assets$2f$multiscale$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$assets$2f$multiscale$2e$png__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object$2c$__ecmascript$29$__ = __turbopack_context__.i('[project]/assets/multiscale.png.mjs { IMAGE => "[project]/assets/multiscale.png (static in ecmascript)" } [app-ssr] (structured image object, ecmascript)');
"use client";
;
;
;
    ...
    const projects = [
        {
            ...
            image: __TURBOPACK__imported__module__$5b$project$5d2f$assets$2f$tradingpic$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$assets$2f$tradingpic$2e$png__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object$2c$__ecmascript$29$__["default"]
        },
        {
            id: 2,
...
"[project]/component/splashcursor.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function Splashcursor({ SIM_RESOLUTION = 128, DYE_RESOLUTION = 512, CAPTURE_RESOLUTION = 512, DENSITY_DISSIPATION = 3.5, VELOCITY_DISSIPATION = 2, PRESSURE = 0.1, PRESSURE_ITERATIONS = 20, CURL = 3, SPLAT_RADIUS = 0.2, SPLAT_FORCE = 6000, SHADING = true, COLOR_UPDATE_SPEED = 10, BACK_COLOR = {
    r: 0.5,
    g: 0,
    b: 0
}, TRANSPARENT = true }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Adjust DYE_RESOLUTION based on device capabilities
        let adjustedDyeResolution;
        const isHighEndDevice = undefined;
        const gl = undefined, ext = undefined;
            ...
            if (!supportRenderTextureFormat(gl, internalFormat, format, type)) {
                if (gl instanceof WebGL2RenderingContext) {
                    switch(internalFormat){
                        case gl.R16F:
                            return getSupportedFormat(gl, gl.RG16F, gl.RG, type) || getSupportedFormat(gl, gl.RGBA16F, gl.RGBA, type);
                        case gl.RG16F:
                            return getSupportedFormat(gl, gl.RGBA16F, gl.RGBA, type);
                        default:
                            console.warn(`Texture format ${internalFormat} not supported, falling back to RGBA`);
                            return getSupportedFormat(gl, gl.RGBA, gl.RGBA, type);
                    }
                } else {
                    console.warn('WebGL1: Falling back to RGBA format');
                    return {
        ...
        function compileShader(type, source, keywords) {
            ...
            const versionDirective = isWebGL2 ? '#version 300 es\n' : '';
            source = versionDirective + addKeywords(source, keywords);
        ...
        const isWebGL2 = undefined;
        const baseVertexShader = undefined;
        const copyShader = undefined;
        const clearShader = undefined;
        const displayShaderSource = undefined;
        const splatShader = undefined;
        const advectionShader = undefined;
        const divergenceShader = undefined;
        const curlShader = undefined;
        const vorticityShader = undefined;
        const pressureShader = undefined;
        const gradientSubtractShader = undefined;
        const blit = undefined;
        let dye, velocity, divergence, curl, pressure;
        const copyProgram = undefined;
        const clearProgram = undefined;
        const splatProgram = undefined;
        const advectionProgram = undefined;
        const divergenceProgram = undefined;
        const curlProgram = undefined;
        const vorticityProgram = undefined;
        const pressureProgram = undefined;
        const gradienSubtractProgram = undefined;
        const displayMaterial = undefined;
        function initFramebuffers() {
            ...
            gl.disable(gl.BLEND);
            if (!dye) dye = createDoubleFBO(dyeRes.width, dyeRes.height, rgba?.internalFormat || gl.RGBA, rgba?.format || gl.RGBA, texType, filtering);
            else dye = resizeDoubleFBO(dye, dyeRes.width, dyeRes.height, rgba?.internalFormat || gl.RGBA, rgba?.format || gl.RGBA, texType, filtering);
            if (!velocity) velocity = createDoubleFBO(simRes.width, simRes.height, rg?.internalFormat || gl.RGBA, rg?.format || gl.RGBA, texType, filtering);
            else velocity = resizeDoubleFBO(velocity, simRes.width, simRes.height, rg?.internalFormat || gl.RGBA, rg?.format || gl.RGBA, texType, filtering);
            divergence = createFBO(simRes.width, simRes.height, r?.internalFormat || gl.RGBA, r?.format || gl.RGBA, texType, gl.NEAREST);
            curl = createFBO(simRes.width, simRes.height, r?.internalFormat || gl.RGBA, r?.format || gl.RGBA, texType, gl.NEAREST);
            pressure = createDoubleFBO(simRes.width, simRes.height, r?.internalFormat || gl.RGBA, r?.format || gl.RGBA, texType, gl.NEAREST);
        }
        ...
        const handleFirstMouseMove = undefined;
        const handleMouseMove = undefined;
        const handleTouchStart = undefined;
        const handleFirstTouchStart = undefined;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
            ...
            fileName: "[project]/component/splashcursor.tsx",
            lineNumber: 1438,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c988eb81._.js.map